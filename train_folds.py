...
from utils import seed_everything, evaluate_new
...
parser.add_argument('--n_splits', type=int, default=5, help='k-folds')
...
for fold in range(args.n_splits):
    ...
    train_dataloader, test_dataloader = get_dataloaders(batch_size=args.batch_size, fold=fold, model_type=args.model_type, n_splits=args.n_splits)
    ...
    for epoch in range(args.num_epochs):
        ...
        if eval_f1 > best_f1:
            ...
            torch.save(state_dict, f'saved_models/folds_{args.n_splits}/xlm_roberta_large_fold_{fold}.pt')
